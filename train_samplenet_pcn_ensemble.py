...
sampler_ckpt = torch.load('log/samplenet_meta/16_6all_24_2021-12-27_08-25-23/90.pth')
...
"""Create Ckpt dir"""
saving_dir = 'log/samplenet_meta/'+str(out_points)+'pcn_ensemble_'+datetime.now().strftime('%Y-%m-%d_%H-%M-%S')+'/'
